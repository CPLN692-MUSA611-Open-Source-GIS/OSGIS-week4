...
var query4= _.where(bakeGoods, {"type": "Cake", year: 1611});
...
var query5 = _.filter(bakedGoods, function(goods) {return goods.price > 4}) 
...
var query6 = _.sortBy(bakedGoods, function(goods){return goods.inventory});
...
var query7= _.groupBy(bakedGoods, function(goods){return goods.type});
