...
var query5 = _.filter(bakedGoods, (good) => good.price > 4);
...
var query6 = _.sortBy(bakedGoods, (good) => Math.min(good.inventory));
...
var query7 = _.groupBy(bakedGoods, (good) => good.type);
