...
var query1 = _.isFunction(bakedGoods);
...
var query2 = _.isArray(printMenu);
...
===================== */
//compound functions: contain many functions
var query3 = _.Object(_.first(bakedGoods));
...
var query5 = _.filter(bakedGoods, function(obj){return obj[3] > 4; });
...
var query6 = _.sortBy(bakedGoods, function(obj){return obj[2]});
...
var query7 = _.groupBy(bakedGoods, function(obj){return obj[1]});
