...
var query5 = _.filter(bakedGoods, function(entry){return (entry.price >= 4)});
...
var printMenuGroups = function(entry){
  type = Object.keys(entry);
  // for(var key in entry){
  //   console.log(key);
  //   _.each(entry[key], function(goods){console.log(goods.name + " ...  $" + goods.price)})
  // };
  _.each(type, function(type){
    console.log(type);
    _.each(entry[type], function(goods){
