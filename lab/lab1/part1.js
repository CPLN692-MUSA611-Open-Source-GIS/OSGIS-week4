...
var query5 = _.filter(bakedGoods, (bake) => {return bake.price > 4}) ;
...
var query6 = _.sortBy(bakedGoods, (inven) => {return inven.inventory});
...
var query7 = _.groupBy(bakedGoods, (goods) => {return goods.type});
...
console.log(printMenuGroups(query7))
